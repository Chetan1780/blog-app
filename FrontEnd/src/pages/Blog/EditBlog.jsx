...
const EditBlog = () => {
  ...
  const { data: blogData,loading:blodLoading} = usefetch(`${getEnv('VITE_API_BACKEND_URL')}/blog/get-blog/${blog_id}`, {
    method: 'get',
    credentials: 'include'
},[blog_id]);
  ...
  if (loading || blodLoading) return <Loading />
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectValue placeholder={field.value ? categoryData.category.find(item => item._id === field.value)?.name || "" : "Category"} />
                        </SelectTrigger>
                        <SelectContent>
